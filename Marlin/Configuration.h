...
#define STRING_CONFIG_H_AUTHOR "(SArroyo, Sapphire Plus)" // Who made the changes.
 ...
 */
#define TEMP_SENSOR_0 1   //default 100k thermistor
...
#define TEMP_SENSOR_BED 11   //200v AC silicone bed
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 1, -40, -0.42 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT _X_HALF_BED   //default: X_CENTER  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT _Y_HALF_BED   //default: Y_CENTER  // Y point for Z homing
#endif
